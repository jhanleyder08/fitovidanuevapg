// Base de datos de productos - Fitovida
const products = [
    {
        id: 1,
...
// Función para obtener todos los productos (desde localStorage si existe, sino usar datos por defecto)
function getAllProducts() {
    const stored = localStorage.getItem('fitovida_products');
    if (stored) {
